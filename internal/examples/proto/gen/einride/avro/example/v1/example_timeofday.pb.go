...
var file_einride_avro_example_v1_example_timeofday_proto_goTypes = []any{
...
func file_einride_avro_example_v1_example_timeofday_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_einride_avro_example_v1_example_timeofday_proto_msgTypes[0].Exporter = func(v any, i int) any {

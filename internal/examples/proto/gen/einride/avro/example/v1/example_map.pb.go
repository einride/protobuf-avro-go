...
var file_einride_avro_example_v1_example_map_proto_rawDesc = []byte{
	...
	0x41, 0x4c, 0x55, 0x45, 0x32, 0x10, 0x02, 0x42, 0x63, 0x5a, 0x61, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_einride_avro_example_v1_example_map_proto_goTypes = []interface{}{
...
func file_einride_avro_example_v1_example_map_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_einride_avro_example_v1_example_map_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_einride_avro_example_v1_example_map_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {

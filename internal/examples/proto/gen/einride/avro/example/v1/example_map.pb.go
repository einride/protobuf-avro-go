...
func file_einride_avro_example_v1_example_map_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_einride_avro_example_v1_example_map_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_einride_avro_example_v1_example_map_proto_msgTypes[9].Exporter = func(v any, i int) any {
